...
class loginController extends Controller {
  ...
  function post_login()
  {
    ...
    if(!$usuario = usuarioModel::list('usuarios',['nombreUsuario_usuario' => clean($_POST['usuario']), 'claveUsuario_usuario' => clean($_POST['password'])], 1)){
      Flasher::new('Las credenciales no son correctas.', 'danger');
      Redirect::back();
    }

    // Loggear al usuario
    Auth::login($usuario['id_usuario'], $usuario);
    Redirect::to('home');
  }
}