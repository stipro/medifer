<!-- Modal -->
<div class="modal fade" id="mdView-laboratory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <form id="view_laboratory_form">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">[Vista] Laboratorio</h5>
        ...
        <div class="modal-footer">
          <button type="button" id="mbtnView-laboratory-close" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
        </div>
      </div>
    </form>
  </div>
